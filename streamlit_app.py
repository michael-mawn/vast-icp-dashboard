...
from src.views import v1_composition, v2_migration, v4_assumptions
...
def ensure_data() -> None:
    ...
    gitignored, so the app must build it once on first load, with the
    approved config defaults (no slider overrides)."""
